...
export class ForgetpasswordComponent {
  ...
  step:number = 1
    ...
    verifyEmailSubmit():void{
      ...
      let emailVal = this.verifyEmail.get('email')?.value // email value
      this.resetPassword.get('email')?.patchValue(emailVal) // value of the email in the third form taken freom firs form
